...
The [`Table` interface](../../../javadocs/{{% icebergVersion %}}/index.html?org/apache/iceberg/Table.html) provides access to the table metadata:
...
`Table` also exposes operations that update the table. These operations use a builder pattern, [`PendingUpdate`](../../../javadocs/{{% icebergVersion %}}/index.html?org/apache/iceberg/PendingUpdate.html), that commits when `PendingUpdate#commit` is called.
...
Iceberg data types are located in the [`org.apache.iceberg.types` package](../../../javadocs/{{% icebergVersion %}}/index.html?org/apache/iceberg/types/package-summary.html).
...
Iceberg's expressions are used to configure table scans. To create expressions, use the factory methods in [`Expressions`](../../../javadocs/{{% icebergVersion %}}/index.html?org/apache/iceberg/expressions/Expressions.html).
